...
public class BottomDetailActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.bottom_detail_activity);
        ...
        TextView tvName = findViewById(R.id.tv_bottom_detail);
        tvName.setText(intent.getStringExtra("Bottom Name "));
        ...
        btnAddCart.setOnClickListener(new View.OnClickListener()
        {
            ...
            public void onClick (View view){
                ...
                Intent intent = new Intent(BottomDetailActivity.this,BottomCheckOut.class);
                Toast.makeText(BottomDetailActivity.this, "Added to cart list", Toast.LENGTH_SHORT).show();
    ...
    private void ShowSizeOptions() {
        ...
        AlertDialog.Builder builder = new AlertDialog.Builder(BottomDetailActivity.this);
