...
public class TopDetailActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        TextView tvName = findViewById(R.id.tv_top_detail);
        tvName.setText(intent.getStringExtra("Top Name "));
        ...
        btnAddCart.setOnClickListener(new View.OnClickListener()
        {
            ...
            public void onClick (View view){
                ...
                Intent intent = new Intent(TopDetailActivity.this,BottomCheckOut.class);
                Toast.makeText(TopDetailActivity.this, "Added to cart list", Toast.LENGTH_SHORT).show();
    ...
    private void ShowSizeOptions() {
        ...
        AlertDialog.Builder builder = new AlertDialog.Builder(TopDetailActivity.this);
