...
public class BottomCheckOut extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tvSize = findViewById(R.id.tv_size_order_detail);
    ...
    public void onClick(View view) {
        ...
        emailIntent.putExtra(Intent.EXTRA_EMAIL, new String[]{"farahdiana702@gmail.com"});

        if(emailIntent.resolveActivity(getPackageManager())!=null) {
        startActivity(emailIntent);
        }
        else {
        Toast.makeText(BottomCheckOut.this, "Sorry, no app can handle this action and data", Toast.LENGTH_SHORT).show();
        }
