...
public class ShoesCheckOut extends AppCompatActivity implements View.OnClickListener {
    ...
    public void onClick(View view) {
        ...
        if(emailIntent.resolveActivity(getPackageManager())!=null) {
            ...
            Toast.makeText(ShoesCheckOut.this, "Sorry, no app can handle this action and data", Toast.LENGTH_SHORT).show();
        }
