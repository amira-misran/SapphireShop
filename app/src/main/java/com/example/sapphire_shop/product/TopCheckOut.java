...
import com.example.sapphire_shop.HomeActivity;
import com.example.sapphire_shop.R;
import com.example.sapphire_shop.databinding.BottomCheckOutBinding;

public class TopCheckOut extends AppCompatActivity implements View.OnClickListener {

    ImageButton imgBtnEmail,btnCheckOut;
    TextView tvItem, tvQuantity, tvSize, tvPrice;
    String name;
    int quantity;
    ...
    public void onClick(View view) {
        ...
        if(emailIntent.resolveActivity(getPackageManager())!=null) {
            ...
            Toast.makeText(TopCheckOut.this, "Sorry, no app can handle this action and data", Toast.LENGTH_SHORT).show();
        }
        ...
        btnCheckOut.setOnClickListener(new View.OnClickListener() {
            ...
            @Override
                ...
                Toast.makeText(TopCheckOut.this, "Order Successfully", Toast.LENGTH_SHORT).show();
