...
public class DressDetailActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.dress_detail_activity);
        ...
        TextView tvName = findViewById(R.id.tv_dress_detail);
        tvName.setText(intent.getStringExtra("Dress Name"));
        ...
        btnAddCart.setOnClickListener(new View.OnClickListener()
        {
            ...
            public void onClick (View view){
                ...
                Intent intent = new Intent(DressDetailActivity.this,BottomCheckOut.class);
                Toast.makeText(DressDetailActivity.this, "Added to cart list", Toast.LENGTH_SHORT).show();
    ...
    private void ShowSizeOptions() {
        ...
        AlertDialog.Builder builder = new AlertDialog.Builder(DressDetailActivity.this);
